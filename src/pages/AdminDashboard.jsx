...
// Login View Component - Stateless UI
const LoginView = ({ loginEmail, setLoginEmail, loginPassword, setLoginPassword, handleLogin, actionLoading, status }) => {
    return (
        <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            minHeight: '100vh', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
            fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", padding: '20px'
        }}>
            <motion.div
                initial={{ scale: 0.9, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                style={{
                    background: '#fff', padding: '60px 40px', borderRadius: '24px',
...
// Dashboard Content Component - Contains all data management hooks
const DashboardContent = ({ user }) => {
    ...
    useEffect(() => {
        if (activeTab !== 'overview' && activeTab !== 'profiles') {
            fetchData();
...
// Main AdminDashboard Component - Authentication Gate
